...
// const uri = "mongodb+srv://{<db_username>}:<db_password>@cluster0.q5p2qpd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    ...
    app.delete('/coffees/:id', async (req, res) => {
      const id = req.params.id;
      const objectId = new ObjectId(String(req.params.id));
      const query = { _id: objectId };
